...
@WebServlet("/photostudio/detail")
public class PhotoStudioDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute("photostudio", photoStudioDao.get(Integer.parseInt(id)));
        req.getRequestDispatcher("/WEB-INF/view/photostudio/detail.jsp").forward(req, resp);
    }
}
